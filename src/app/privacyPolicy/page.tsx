...
const Datenschutzrichtlinie = () => {
  ...
  return (
    <div className="bg-bg bg-cover bg-fixed min-h-screen max-w-screen flex justify-center items-center md:justify-center md:py-10">
      <div className=" flex flex-col gap-4 justify-center text-start w-full h-full bg-black/50 md:rounded-xl shadow-lg shadow-black backdrop-filter py-5 backdrop-blur-md md:w-2/3 p-10">
          <div>
            <h1 className="text-3xl font-bold mb-4">Datenschutzrichtlinie</h1>
            <p className="mb-4">
              Diese Datenschutzrichtlinie beschreibt, wie unser Team von BLS, mit Sitz in der Rosenstrasse 1, 8400 Winterthur, Informationen sammelt, verwendet und schützt, wenn Sie unsere Website unter <a className="text-blue-500 hover:underline" href="https://www.lunch-guide.ch">https://www.lunch-guide.ch</a> besuchen oder unsere Dienste nutzen. Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst und halten uns an alle geltenden Datenschutzgesetze.
            </p>
          </div>
          <div>
        ...
        <div>
          ...
          <p className="mb-4">
            Ein solcher Ausschluss bedeutet, dass der betreffende Nutzer sich nicht mehr anmelden kann und somit keine Restaurants mehr hinzufügen oder bearbeiten kann. Dieser Ausschluss kann vorübergehend oder dauerhaft sein und liegt im alleinigen Ermessen von BLS.
          </p>
        </div>
        <div>
        ...
        <CustomButton
            text="Zurück"
            size="custom"
            custom="text-2xl w-1/3 self-center h-16"
            onClick={()=>{router.back()}}
          />
      </div>
    </div>
