...
const page = () => {
  ...
  return (
    <div className="bg-bg bg-cover h-screen w-screen flex justify-center items-center md:justify-end">
      ...
      <div className="flex flex-col gap-10 justify-center items-center w-full h-full bg-black/50 md:rounded-xl shadow-lg shadow-black backdrop-filter py-5 backdrop-blur-md md:size-11/12 md:w-1/3 md:mr-10">
        <p className="font-bold text-white md:h-1/4 text-5xl">Registrieren</p>
